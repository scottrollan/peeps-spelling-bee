...
export default function CommandButtons({ shuffle, tryWord, deleteLtr }) {
  return (
    <div className={styles.actions}>
      <div className={styles.action} onClick={() => deleteLtr()}>
        Delete
      </div>
      ...
      <div className={styles.action} onClick={() => tryWord()}>
        Enter
      </div>
    </div>
  );
